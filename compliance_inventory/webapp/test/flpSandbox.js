		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Inventory",
									"targetURL": "#commaventiccomplianceinventory-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commaventiccomplianceinventory-display": {
								"semanticObject": "commaventiccomplianceinventory",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.maventic.complianceinventory",
									"url": sap.ui.require.toUrl("com/maventic/complianceinventory")
								}
							}
						}
					}
