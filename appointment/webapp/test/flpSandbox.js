		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Test App",
									"targetURL": "#comappointment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappointment-display": {
								"semanticObject": "comappointment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.appointment",
									"url": sap.ui.require.toUrl("com/appointment")
								}
							}
						}
					}
